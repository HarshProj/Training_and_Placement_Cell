    ...
    <div className="w-full flex flex-col items-center justify-center mt-12 pt-8 border-t border-gray-200">
      <div className="grid grid-cols-5 w-[90%] max-md:w-[80%] min-h-[280px] max-md:grid-cols-1 max-md:gap-10 mb-6">
        <div className="col-span-2 max-md:col-span-1 flex flex-col gap-4">
          <h3 className="text-3xl font-bold relative after:content-[''] after:absolute after:bottom-0 after:left-0 after:w-12 after:h-1 after:bg-blue-600 after:transition-all hover:after:w-24 pb-2">
            TPO KNIT
          </h3>
        ...
        <div className="flex flex-col gap-3">
          <h3 className="font-semibold text-lg relative after:content-[''] after:absolute after:bottom-0 after:left-0 after:w-8 after:h-0.5 after:bg-blue-600 pb-2 mb-2">
            Downloads
          </h3>
          <a
        ...
        <div className="flex flex-col gap-3">
          ...
          <a
            href="/CodeOfConduct"
            className="text-gray-400 cursor-pointer hover:underline hover:text-gray-600 transform hover:translate-x-1 transition-all duration-300"
          >
      ...
      <div className="w-full bg-black text-center py-4 text-white">
        <p className="hover:text-blue-300 transition-colors duration-300">
          Designed & Maintained by Training & Placement Cell, KNIT Sultanpur
        </p>
