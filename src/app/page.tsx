...
<div className=" h-full   flex flex-col justify-center gap-2 "><h2 className="text-4xl">Training & Placement Office
</h2>
</div>
    </div>
    <div className=" w-[90%] bg-gradient-to-r from-slate-50 to-slate-400 border-t-0 h-[1px] mx-[3px] my-[4px]"></div>
<h3 className="text-2xl font-light">Kamla Nehru Institute of Technology,Sultanpur</h3>
    </div>
   </div>
