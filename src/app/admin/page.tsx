...
const AdminPage = () => {
  ...
  // Function to handle tab selection that also closes the mobile sidebar
  const handleTabSelection = (tab: "add" | "list" | "orders" | "updates" | "feedback" | "directory") => {
    setActiveTab(tab);
    setIsMobileSidebarOpen(false); // Close the mobile sidebar after selection
  };
  ...
  const getCurrentTabName = () => {
    switch (activeTab) {
      case "add":
        return "Add Recruitment Data";
      case "list":
        return "Visited Companies";
      case "directory":
  ...
  return (
    <div className="flex flex-col md:flex-row h-screen pt-16 bg-gray-50 text-gray-800">
      ...
      {isMobileSidebarOpen && (
        <div className="md:hidden w-full absolute top-28 left-0 z-20 bg-white shadow-lg border-t border-gray-200">
          <div className="space-y-2 p-3">
            <button
              onClick={() => handleTabSelection("add")}
            ...
            <button
              onClick={() => handleTabSelection("directory")}
              className={`w-full text-left px-4 py-3 border rounded transition ${
                activeTab === "directory"
                  ? "bg-blue-100 border-blue-500 text-blue-800"
                  : "hover:bg-gray-100 border-gray-300"
            ...
            <button
              onClick={() => handleTabSelection("updates")}
              className={`w-full text-left px-4 py-3 border rounded transition ${
                activeTab === "updates"
                  ? "bg-blue-100 border-blue-500 text-blue-800"
                  : "hover:bg-gray-100 border-gray-300"
            ...
            <button
              onClick={logout}
              className="w-full text-left px-4 py-3 border rounded bg-red-500 text-white hover:bg-red-600 transition"
            >
              🚪 Logout
            </button>
          </div>
      ...
      <div className="hidden md:block md:w-1/5 border-r p-4 bg-white shadow-md">
      ...
      <div className="flex-1 p-4 md:p-10 overflow-y-auto">
        {activeTab === "add" && (
          <div>
            <h2 className="text-xl md:text-2xl font-semibold mb-4 md:mb-6 text-blue-700 hidden md:block">
        ...
        {activeTab === "updates" && (
          <div>
            ...
            {/* Update Form */}
            <form onSubmit={handleUpdateSubmit} className="mb-6 md:mb-10">
              {/* Title */}
              <div className="mb-4">
            ...
            {/* Updates List */}
            <h3 className="text-lg md:text-xl font-semibold mb-4 text-blue-700 border-t pt-6">
              Current Updates
            </h3>
                ...
                {updates.map((update) => (
                  ...
                  >
                    <div className="flex flex-col sm:flex-row sm:justify-between">
                      <h4 className="font-semibold text-lg mb-2 sm:mb-0">{update.title}</h4>
            ...
            {feedbackLoading ? (
              ...
              <div className="grid gap-4 grid-cols-1 md:grid-cols-2">
                {recruiterFeedback.map((feedback) => (
                  <div
                    key={feedback._id}
                    className="bg-white rounded-lg shadow-md p-4 md:p-5 border border-gray-100"
                  >
                    <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start mb-3">
                      ...
                      <div className="text-yellow-500 text-lg font-semibold mt-2 sm:mt-0">
                    ...
                    <div className="flex flex-col sm:flex-row sm:justify-between text-sm text-gray-500 pt-2 border-t">
                      <span className="mb-1 sm:mb-0">📞 {feedback.phone}</span>
                      <span>
